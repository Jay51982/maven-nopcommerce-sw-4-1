...
public class CheckoutPage extends Utility {
    ...
    public void enterEmail() {
        sendTextToElement(emailField, "abc@gmail.com");
    }
    ...
    public void enterAddress1() {
        sendTextToElement(address1Field, "Brighton Road");
    }

    public void enterZipPostalCode() {
        sendTextToElement(zipPostalCode, "123 456");
    }

    public void enterPhoneNumber() {
        sendTextToElement(phoneNumber, "07821363535");
    }
    ...
    public void enterCardNumber() {
        sendTextToElement(cardNumber, "1111 2222 3333 4444");
    }
    ...
    public void enterAddressField1Nokia() {
        sendTextToElement(addressField1Nokia, "Brighton Road");
    }

    public void enterZipCodeNokia() {
        sendTextToElement(zipCodeNokia, "123 465");

    }

    public void enterPhoneNumberNokia() {
        sendTextToElement(phoneNumberNokia, "07824521521");
    }
    ...
    public void enterCardHolderNameNokia() {
        sendTextToElement(cardHolderNameNokia, "Mr Smith");
    }

    public void enterCardNumberNokia() {
        sendTextToElement(cardNumberNokia, "5555 6666 3333 4444");
    }
    ...
    public void enterExpiryYearNokia() {
        sendTextToElement(expiryYearNokia, "2024");
    }
